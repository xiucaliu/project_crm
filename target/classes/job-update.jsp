                    ...
                    <div class="white-box">
                        <form action="<c:url value="/job/update" />" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select name="leader" class="form-control form-control-line">
                                        <option value="${leaderId}"><c:out value="${leaderName}"/></option>
                                        <c:forEach var="listObj" items="${leaderList}">
                                            <c:if test="${ leaderId != listObj.id}">
                                                <option value="${listObj.id}"><c:out
                                                        value="${listObj.fullname}"/></option>
                                            </c:if>
                                        </c:forEach>
                                    </select>
                                </div>
