        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <c:forEach var="userListObj" items="${userList}">
                    <div class="col-xs-12">
                        <a href= <c:url value= "/user/details?id=${userListObj.id}"/> class="group-title">
                            <img width="30" src=<c:url value = "/plugins/images/users/${userListObj.avatar}"/>  class="img-circle" />
